              ...
              <div className="flex items-center gap-3 flex-wrap">
                {userInfo.githubLink && (
                  <motion.a
                    ...
                    whileTap={{ scale: 0.95 }}
                    className="inline-flex items-center gap-2 px-5 py-2.5 bg-gray-900 hover:bg-gray-800 text-white rounded-lg font-semibold shadow-lg hover:shadow-xl transition-all duration-200 group"
                  >
                    <svg
                      className="w-5 h-5"
                      fill="currentColor"
                ...
                {isOwnProfile && (
                  <motion.button
                    ...
                    whileHover={{ scale: 1.05 }}
                    whileTap={{ scale: 0.95 }}
                    className="px-6 py-2.5 bg-primary text-white rounded-lg hover:bg-secondary transition-colors font-semibold shadow-lg hover:shadow-xl"
                  >
                    소셜 보기
                  </motion.button>
                )}
